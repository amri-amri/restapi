...
the URL of the database connection you want to use, and `dbUsername`
...
In order to run the tests in your IDE, an additional database called
`onkocase_test` should be created on your MySQL Server. Use the same
SQL commands you used to create the `onkocase` database. Also,
