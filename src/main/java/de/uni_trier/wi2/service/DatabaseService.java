...
public class DatabaseService {
    ...
    public static String connectToDatabase() throws ClassNotFoundException, SQLException {
        METHOD_CALL.info("public static String restapi.service.DatabaseService.connectToDatabase()...");

        Class.forName("com.mysql.cj.jdbc.Driver");
        connection = DriverManager.getConnection(url, username, password);
        connection.prepareStatement("SHOW TABLES").execute();

        METHOD_CALL.info("restapi.service.DatabaseService.connectToDatabase(): Connected to database");
    ...
    public static String[] putLog(String xes) throws XESnotValidException, SQLException, IOException, SAXException {
        METHOD_CALL.info("public static String[] restapi.service.DatabaseService.putLog(String xes)\n" +
    ...
    public static Map<String, Object> getLog(String logID) throws SQLException {
        METHOD_CALL.info("public static String[] restapi.service.DatabaseService.getLog(String logID={})", logID);
    ...
    public static int removeLog(String logID) throws SQLException {
        METHOD_CALL.info("public static int restapi.service.DatabaseService.removeLog(String logID={})", logID);
    ...
    public static Map<String, Object> getTrace(String traceID) throws SQLException {
        METHOD_CALL.info("public static Map<String, Object> restapi.service.DatabaseService.getTrace(String traceID={})", traceID);
    ...
    public static String[] getTraceIDs(String logID) throws SQLException {
        METHOD_CALL.info("public static String[] restapi.service.DatabaseService.getTraceIDs(String logID={})", logID);
    ...
    public static List<Map<String, Object>> getTraces(String logID) throws SQLException {
        METHOD_CALL.info("public static List<Map<String, Object>> restapi.service.DatabaseService.getTraces(String logID={})",
                logID);
    ...
    public static String[] getLogIDs(boolean includeRemoved) throws SQLException {
        METHOD_CALL.info("public static String[] restapi.service.DatabaseService.getlogIDs(boolean includeRemoved={})",
                includeRemoved);
    ...
    public static String putTraceMetadata(String traceID, String metadataType, String metadataValue) throws SQLException {
        ...
        METHOD_CALL.info("restapi.service.DatabaseService.putTraceMetadata(String, String, String): return metadataID = {}",
                metadataID);
        return metadataID;
    }
    ...
    public static String putLogMetadata(String logID, String metadataType, String metadataValue) throws SQLException {
        ...
        METHOD_CALL.info("restapi.service.DatabaseService.putLogMetadata(String, String, String): return metadataID = {}",
                metadataID);
        return metadataID;
    }
    ...
    public static Map<String, String> getTraceMetadata(String traceID) throws SQLException {
        METHOD_CALL.info("public static Map<String, String> restapi.service.DatabaseService.getTraceMetadata(String traceID={})...",
                traceID);
        ...
        METHOD_CALL.info("restapi.service.DatabaseService.getTraceMetadata(String): return metadata = {}",
                metadata);
        return metadata;
    }
    ...
    public static Map<String, String> getLogMetadata(String logID) throws SQLException {
        METHOD_CALL.info("public static Map<String, String> restapi.service.DatabaseService.getLogMetadata(String traceID={})...",
                logID);
        ...
        METHOD_CALL.info("restapi.service.DatabaseService.getLogMetadata(String): return metadata = {}",
                metadata);
        return metadata;
    }
    ...
    public static void startTransaction() throws SQLException {
        METHOD_CALL.info("public static void restapi.service.DatabaseService.startTransaction()");
        connection.prepareStatement("start transaction;").execute();
    }

    public static void savepoint(String identifier) throws SQLException {
        METHOD_CALL.info("public static void restapi.service.DatabaseService.savepoint( \"{}\" )", identifier);
    ...
    public static void rollbackTo(String identifier) throws SQLException {
        METHOD_CALL.info("public static void restapi.service.DatabaseService.rollbackTo( \"{}\" )", identifier);
        connection.prepareStatement("rollback to savepoint " + identifier + ";").execute();
    }

    public static void commit() throws SQLException {
        METHOD_CALL.info("public static void restapi.service.DatabaseService.commit()");
    ...
    public static void deleteAll() throws SQLException, IOException {
        METHOD_CALL.info("public static void restapi.service.DatabaseService.deleteAll()");
    ...
    public static boolean logIsValid(@NotNull String xml) throws SAXException, IOException {
        METHOD_CALL.info("public static boolean restapi.service.DatabaseService.logIsValid( \"{}\" )", maxSubstring(xml));
    ...
    public static boolean traceIsValid(@NotNull String xml) throws IOException, SAXException {
        METHOD_CALL.info("public static boolean restapi.service.DatabaseService.traceIsValid(String xml)");
